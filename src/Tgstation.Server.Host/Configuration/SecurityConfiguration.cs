...
namespace Tgstation.Server.Host.Configuration
{
	...
	sealed class SecurityConfiguration
	{
		...
		/// <summary>
		/// Amount of minutes until <see cref="TokenResponse"/>s generated from passwords expire.
		/// </summary>
		public uint TokenExpiryMinutes { get; set; } = DefaultTokenExpiryMinutes;

		/// <summary>
		/// Amount of minutes to skew the clock for <see cref="TokenResponse"/> validation.
		/// </summary>
		...
		/// <summary>
		/// Amount of minutes until <see cref="TokenResponse"/>s generated from OAuth logins expire.
		/// </summary>
