...
{
	/// <summary>
	/// Logical OR <see cref="RightsConditional{TRights}"/>.
	/// </summary>
	/// <typeparam name="TRights">The <typeparamref name="TRights"/> to evaluate.</typeparam>
	public sealed class OrRightsConditional<TRights> : RightsConditional<TRights>
		where TRights : Enum
	{
		/// <summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="OrRightsConditional{TRights}"/> class.
		/// </summary>
		/// <param name="lhs">The value of <see cref="lhs"/>.</param>
		/// <param name="rhs">The value of <see cref="rhs"/>.</param>
		public OrRightsConditional(RightsConditional<TRights> lhs, RightsConditional<TRights> rhs)
		{
