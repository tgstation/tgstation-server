...
namespace Tgstation.Server.Host.Jobs
{
	...
	{
		/// <summary>
		/// Get the <see cref="Api.Models.JobResponse.Progress"/> for a <paramref name="job"/>
		/// </summary>
		/// <param name="job">The <see cref="Job"/> to get <see cref="Api.Models.JobResponse.Progress"/> for</param>
		/// <returns>The <see cref="Api.Models.JobResponse.Progress"/> of <paramref name="job"/></returns>
