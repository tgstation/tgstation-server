...
{
	/// <summary>
	/// Adds UserGroups for MSSQL.
	/// </summary>
	public partial class MSAddUserGroups : Migration
	{
		/// <inheritdoc />
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					Id = table.Column<long>(type: "bigint", nullable: false)
						.Annotation("SqlServer:Identity", "1, 1"),
					ByondRights = table.Column<decimal>(type: "decimal(20,0)", nullable: false),
					ChatBotRights = table.Column<decimal>(type: "decimal(20,0)", nullable: false),
					ConfigurationRights = table.Column<decimal>(type: "decimal(20,0)", nullable: false),
					DreamDaemonRights = table.Column<decimal>(type: "decimal(20,0)", nullable: false),
					DreamMakerRights = table.Column<decimal>(type: "decimal(20,0)", nullable: false),
