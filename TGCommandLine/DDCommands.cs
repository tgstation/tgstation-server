...
namespace TGCommandLine
{
	...
	class DDStartCommand : Command
	{
		...
		{
			var res = Service.GetComponent<ITGDreamDaemon>().Start();
	...
	class DDPortCommand : Command
	{
		...
		public override ExitCode Run(IList<string> parameters)
		{
			...
			Service.GetComponent<ITGDreamDaemon>().SetPort(port);
			return ExitCode.Normal;
		}
	...
	class DDVisibilityCommand : Command
	{
		...
		public override ExitCode Run(IList<string> parameters)
		{
			...
			Service.GetComponent<ITGDreamDaemon>().SetVisibility(vis);
			return ExitCode.Normal;
		}
	...
	class DDSecurityCommand : Command
	{
		...
		public override ExitCode Run(IList<string> parameters)
		{
			...
			Service.GetComponent<ITGDreamDaemon>().SetSecurityLevel(sec);
			return ExitCode.Normal;
		}
